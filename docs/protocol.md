        # Value Based Hta: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/value-based-hta.git

        ## Objective

        Value-Based HTA Engine integrates multi-criteria decision analysis with evidence synthesis to produce structured value assessments for health technology appraisals.
        ...
        - Code: https://github.com/mahmood726-cyber/value-based-hta.git
        - Dashboard: https://mahmood726-cyber.github.io/value-based-hta/
